...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Statistic.votes'
        db.delete_column('statistics_statistic', 'votes')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Statistic.votes'
        raise RuntimeError("Cannot reverse this migration. 'Statistic.votes' and its values cannot be restored.")
