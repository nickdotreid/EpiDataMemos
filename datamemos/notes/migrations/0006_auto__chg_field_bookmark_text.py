...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bookmark.text'
        db.alter_column('notes_bookmark', 'text', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Bookmark.text'
        db.alter_column('notes_bookmark', 'text', self.gf('django.db.models.fields.TextField')())
