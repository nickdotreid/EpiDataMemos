...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chart.x_label'
        db.add_column('charts_chart', 'x_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Chart.y_label'
        db.add_column('charts_chart', 'y_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chart.x_label'
        db.delete_column('charts_chart', 'x_label')

        # Deleting field 'Chart.y_label'
        db.delete_column('charts_chart', 'y_label')
