...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.short'
        db.alter_column('charts_tag', 'short', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Tag.short'
        db.alter_column('charts_tag', 'short', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True))
