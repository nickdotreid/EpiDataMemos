...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chart.threshold'
        db.add_column('charts_chart', 'threshold',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chart.threshold'
        db.delete_column('charts_chart', 'threshold')
    ...
    models = {
        ...
        'charts.chart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lock_percent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'threshold': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'charts.footnote': {
            'Meta': {'ordering': "['order']", 'object_name': 'Footnote'},
