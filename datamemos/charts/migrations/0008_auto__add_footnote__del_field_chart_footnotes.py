...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('charts_footnote', (
        ...
        db.send_create_signal('charts', ['Footnote'])

        # Deleting field 'Chart.footnotes'
        db.delete_column('charts_chart', 'footnotes')


    def backwards(self, orm):
        # Deleting model 'Footnote'
        db.delete_table('charts_footnote')

        # Adding field 'Chart.footnotes'
        db.add_column('charts_chart', 'footnotes',
