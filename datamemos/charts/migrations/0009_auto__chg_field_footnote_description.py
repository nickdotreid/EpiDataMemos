...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Footnote.description'
        db.alter_column('charts_footnote', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Footnote.description'
        db.alter_column('charts_footnote', 'description', self.gf('django.db.models.fields.CharField')(max_length=250))
